...
describe('Pruebas en las acciones Auth', () => {
    ...
    test('startLogin correcto', async () => {
        ...
        await store.dispatch(startLogin('vcorsinoa@gmail.com', '123456'))
    ...
    test('startLogin incorrecto', async () => {
        ...
        await store.dispatch(startLogin('vcorsinoa@gmail.com', '123456789'))
        ...
        await store.dispatch(startLogin('vcorsinoa@gmail2.com', '123456'))
